...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    // biome-ignore lint/a11y/useSemanticElements: div with role="group" is intentional to avoid fieldset styling
    <div
      className={cn(
...
function InputGroupAddon({
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: div with role="group" is intentional to avoid fieldset styling
    // biome-ignore lint/a11y/noNoninteractiveElementInteractions: click delegates focus to the input
